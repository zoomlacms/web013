<%@ page language="C#" autoeventwireup="true" inherits="manage_Page_PageManage, App_Web_cck1fx0e" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">
    ...
    { %>
      <div id="help"> <a onclick="help_show('86')" title="帮助"></a></div>
  <%} %>后台管理 &gt;&gt; 企业黄页 &gt;&gt; 黄页管理 &gt;&gt; <a href="PageManage.aspx">黄页列表</a></div>
<div class="clearbox">
</div>
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
    <tbody id="Tabs">
        <tr class="tdbg">
            <td style="height: 24px; width: 100%"  class="title">申请人：
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
    <tbody id="Tbody1">
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td align="center" class="title" style="width:10%"><span class="tdbgleft">ID</span></td>
            <td align="center" class="title" style="width:25%"><span class="tdbgleft">申请人</span></td>
            <td align="center" class="title"><span class="tdbgleft">申请时间</span></td>
            <td align="center" class="title" style="width:30%"><span style="background-color: #e0f7e5; width: 30%">操作</span></td>
        </tr>
        <asp:Repeater ID="Pagetable" runat="server">
            <ItemTemplate>
                <tr class="tdbg" id="<%#Eval("ID") %>" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
