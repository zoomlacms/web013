<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="manage_Page_AuditUser, App_Web_cck1fx0e" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    ...
                    <tr id="Tr2" class="tdbg" runat="server">
                        ...
                        <td align="left" class="tdbgright" style="height: 24px; width: 70%">
                            <input name="proname" id="proname" type="text" value="<%#Eval("CompanyName") %>"
