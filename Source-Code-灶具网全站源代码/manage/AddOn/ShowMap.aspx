<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_ShowMap, App_Web_uvrzhv1m" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
	<tr class="tdbg">
		<td align="left"   style="height:30px; padding-left:60px; padding-bottom:20px; padding-top:30px;">
		 ...
		 &nbsp; <input id="Button1" type="button" value="获取地图代码" class="C_input"  onclick="copy()"/>
