<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_Sql, App_Web_tmzx1pcx" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>SQL执行</title>
    ...
    <tr class="tdbg">
        <td colspan="2">
            <div style="margin: 5px;">
                输入您要执行SQL语句：<br />
                <asp:TextBox ID="TextBox1" runat="server" AutoCompleteType="Disabled" TextMode="MultiLine"
                    CssClass="x_input" Style="width: 780px; height: 170px;"></asp:TextBox>
                <br />
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border"
    id="crt2" name="crt2" style="display: none; height:220px; margin:auto;">
    <tr class="title">
        <td colspan="2">
            请上传达标准T-SQL文件查询
        </td>
