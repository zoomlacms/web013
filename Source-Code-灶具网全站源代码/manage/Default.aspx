<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.index, App_Web_ki43tn4n" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
                        ...
                        <div id="Menu_2" style="width: 100%; display: none;">
                            <ul>
                                ...
                                <%}
                                  ...
                                  { %>
                                <li><a href="javascript:ShowMain('GuestBook/BbsGuide.aspx','GuestBook/GuestCateMana.aspx')">
                        ...
                        <div id="Menu_3" style="display: none;">
                            <ul>
                                ...
                                <% 
                                    ...
                                    {%>
                                <li><a href="javascript:ShowMain('User/MessageLink.aspx','User/Message.aspx')">
                        ...
                        <div id="Menu_7" style="width: 100%; display: none;">
                            <ul>
                                ...
                                <li><a href="javascript:ShowMain('3Dmanage/WareGuide.aspx','3Dmanage/Waremanage.aspx')">
                                    商品管理</a></li>
                                <li><a href="javascript:void(0);" onclick="ShowHideLayer(3,0);ShowMainsgourl('User/AdminLink.aspx','User/AdminManage.aspx')">
                                    返回菜单</a></li>
                            </ul>
                        </div>
                        <!-- SiteServer -->
