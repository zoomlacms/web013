<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.MessageRead, App_Web_lhzqglb3" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>阅读短消息</title>
