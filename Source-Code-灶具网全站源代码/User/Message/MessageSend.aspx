<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.MessageSend, App_Web_lhzqglb3" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<script>
var a='<%Call.Label("{ZL.Label id=\"根据ID得到标题\"/}"); %>';
var b='<%Call.Label("{ZL.Label id=\"根据ID得到用户名\"/}"); %>';
document.getElementById("TxtInceptUser").value=b;
 document.getElementById("TxtTitle").value="我对贵公司的“"+a+"”很感兴趣";
</script>
