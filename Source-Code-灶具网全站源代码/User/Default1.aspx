<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="User_Default, App_Web_n4inp2vy" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<html>
...
window.onload = function () {
            ...
            document.getElementById("RightHeight").height = document.documentElement.clientHeight - 192;
             }
        }
var returnvalue;
  ...
  <table border="0" cellpadding="0" cellspacing="0" style=" height:100%; width:100%;">
    ...
    <tr>
      <td valign="top" style="width: 176px; background: #C7E2F2;" id="MENU"><table border="0" cellpadding="0" cellspacing="0" id="MENU2" name="MENU2" style="width:185px;height:100%;">
          <tr>
            <td width="155" height="98%" valign="top" class="leftmenu_bk" style="display: block; padding: 10px;"><table style=" height:100%; width:100%;" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E6F2F8">
                <tr>
          ...
          <tr>
            <td colspan="2" style="height:100%; background: white; " align="center"><div id="OPAD" style="height: 100%; width: 99%; background: white; overflow: auto; text-align: left">
                <table  style=" height:100%; width:100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td valign="top" style="padding: 5px; height: 100%"><iframe height="100%" frameborder="0" marginwidth="0" marginheight="0" scrolling="auto"	allowtransparency="true" id="main_right" name="main_right" style="padding-left: 4px; overflow-x: hidden; overflow-y: auto;" src="/user/Message/MessageSend.aspx?id=<%Call.Label("{$GetRequest(ID)$}"); %>" onload="loadaction()"></iframe></td>
                  </tr>
                </table>
              </div></td>
          </tr>
