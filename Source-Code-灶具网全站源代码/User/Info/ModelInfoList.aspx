<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.ModelInfoList, App_Web_3vjs3sc5" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>用户模型列表</title>
