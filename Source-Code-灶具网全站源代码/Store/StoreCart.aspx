<%@ page language="C#" autoeventwireup="true" inherits="StoreCart, App_Web_xsasewuv" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>加入购物车</title>
...
<form id="form1" runat="server">
 ...
 <div class="cart_con">
    ...
    <div class="jia">
      ...
      <li style="width:250px;text-align:left;">运费：<asp:Label ID="farePrice" runat="server" Text=""></asp:Label></li>
