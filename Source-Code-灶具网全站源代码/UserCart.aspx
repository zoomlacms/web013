<%@ page language="C#" autoeventwireup="true" inherits="WebShop_UserCart, App_Web_wbumxqjw" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>加入购物车</title>
...
<div id="main" class="rg_inout">
    ...
    <ul>
        ...
        <li><asp:Button ID="Button1" runat="server" Text="去收银台结帐" OnClick="Button1_Click" /></li>
